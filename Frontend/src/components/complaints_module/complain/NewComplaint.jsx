    ...
    <aside className="space-y-5">
      ...
      <div className="rounded-[28px] bg-gradient-to-r from-fuchsia-600 via-pink-600 to-rose-600 p-5 text-white shadow-[0_20px_60px_-30px_rgba(219,39,119,0.8)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-pink-100">Automatic category-based priority</p>
          </div>
        </div>
      ...
      <div className="rounded-[28px] bg-gradient-to-r from-emerald-600 to-green-500 p-5 text-white shadow-[0_20px_60px_-30px_rgba(16,185,129,0.85)]">
        ...
        <p className="mt-4 text-sm leading-7 text-indigo-50">
          Upload a clear image of the complaint if available. Supported formats are
          JPG, JPEG, PNG, and WEBP, with a maximum size of 3MB.
        </p>
      </div>
      ...
      <div className="rounded-[28px] bg-gradient-to-r from-rose-600 to-pink-600 p-5 text-white shadow-[0_20px_60px_-30px_rgba(244,63,94,0.8)]">
        ...
        <p className="mt-4 text-sm text-rose-50">
          Use this support contact for urgent hostel maintenance issues that require
          immediate attention.
        </p>
      ...
      <div className="w-full space-y-8 px-4 sm:px-6 lg:px-8 2xl:px-10">
        ...
        <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div>
                ...
                {errors.studentName ? (
                  ...
                  <p className="mt-2 text-xs text-slate-500">
                    Use 5 to 20 English letters and spaces only. Example: Nimal Perera
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.studentId ? (
                  ...
                  <p className="mt-2 text-xs text-slate-500">
                    Must include both English letters and numbers. Example: IT20234567
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div>
                <label className="text-sm font-bold text-slate-700">Complaint Category</label>
                <select
                  value={form.category}
            ...
            <div className="mt-5 grid gap-5 md:grid-cols-2">
              <div>
                <label className="text-sm font-bold text-slate-700">Block / Hostel</label>
                <input
                  value={form.block}
            ...
            <div className="mt-5">
              ...
              {errors.image ? (
                <p className="mt-2 text-xs font-medium text-rose-600">{errors.image}</p>
              ) : null}
